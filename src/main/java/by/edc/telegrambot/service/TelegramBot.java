...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (message != null && message.hasText()) {
            ...
            } else if (message.getText().startsWith("/lecture_table") && message.getText().length() >=15) {
                try {
                    sendMsg(message, LectureTable.getLectureTable(message.getText().substring(15), tableModel));
                } catch (IOException e) {
